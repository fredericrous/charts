...
|-------|---------|-------------|-------------|
| [homelab-preview-operator](charts/homelab-preview-operator/) | 0.10.1 | 0.10.1 | A Kubernetes operator that automatically configures preview environments for applications |
