...
|-------|---------|-------------|-------------|
| [duro-app](charts/duro-app/) | 1.36.3 | 1.36.3 | A household management dashboard with invite system |
| [kb-vision](charts/kb-vision/) | 0.10.6 | 0.10.6 | Knowledge Base for Homelab |
