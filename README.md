...
|-------|---------|-------------|-------------|
| [duro-app](charts/duro-app/) | 1.41.5 | 1.41.5 | A household management dashboard with invite system |
| [kb-vision](charts/kb-vision/) | 0.10.7 | 0.10.7 | Knowledge Base for Homelab |
