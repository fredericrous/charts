...
|-------|---------|-------------|-------------|
| [kb-vision](charts/kb-vision/) | 0.10.5 | 0.10.5 | Knowledge Base for Homelab |
...
| [duro-app](charts/duro-app/) | 1.36.1 | 1.36.1 | A household management dashboard with invite system |
