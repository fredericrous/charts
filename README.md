...
|-------|---------|-------------|-------------|
| [homelab-preview-operator](charts/homelab-preview-operator/) | 0.5.1 | 0.5.1 | A Kubernetes operator that automatically configures preview environments for applications |
