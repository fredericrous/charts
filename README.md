...
|-------|---------|-------------|-------------|
| [builder-webapp](charts/builder-webapp/) | 0.0.29 | 0.0.29 | website-builder SPA + auth backend (openauth client + session cookie) |
| [social-planner](charts/social-planner/) | 0.1.7 | 0.1.7 | Self-hosted social content planner (recommendation + week planner) |
