...
|-------|---------|-------------|-------------|
| [homelab-preview-operator](charts/homelab-preview-operator/) | 0.4.2 | 0.4.2 | A Kubernetes operator that automatically configures preview environments for applications |
