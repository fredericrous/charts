...
|-------|---------|-------------|-------------|
| [homelab-preview-operator](charts/homelab-preview-operator/) | 0.5.4 | 0.5.4 | A Kubernetes operator that automatically configures preview environments for applications |
