...
|-------|---------|-------------|-------------|
| [duro-app](charts/duro-app/) | 1.10.0 | 1.10.0 | A household management dashboard with invite system |
...
| [cluster-vision](charts/cluster-vision/) | 0.12.0 | 0.12.0 | Auto-generated infrastructure diagrams from live Kubernetes state |
