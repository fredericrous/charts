...
|-------|---------|-------------|-------------|
| [homelab-preview-operator](charts/homelab-preview-operator/) | 0.5.0 | 0.5.0 | A Kubernetes operator that automatically configures preview environments for applications |
